-- Views
-- Sirve para emcapsular una consulta muy grande
-- Sintaxis
...
-- "drop view" es para borrar
-- "alter view" es para hacer un cambio
-- "order by" no se puede ejecutar en las views solo despues de que se creo
