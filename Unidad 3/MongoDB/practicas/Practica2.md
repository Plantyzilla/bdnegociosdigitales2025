...
use curso
```
![Respuesta](../img/P2%20Paso2.png)

3. Buscar todos los empleados que trabajen en google
```json
db.empleados.find({empresa: 'Gooogle'})
```

![Respuesta](../img/P2%20Paso3.png)

4. Empleados que vivan en peru
```json
db.empleados.find({país: 'Peru'})
```

![Respuesta](../img/P2%20Paso4.png)
...
![Respuesta](../img/P2%20Paso5.png)

6. Empleados con ventas inferiores a 10000
```json
db.empleados.find({salario: {$lt: 10000}})
```
![Respuesta](../img/P2%20Paso6.png)
...
![Respuesta](../img/P2%20Paso8.png)

9. Empleados de amazon que ganen mas de 9000 dolares
```json
db.empleados.find(
{
	empresa: 'Amazon', salario: {$gt:8000}
}
)
```
![Respuesta](../img/P2%20Paso9.png)
...
db.empleados.find(
{
	$and: [
		...
		{$or: [{editorial: 'Google'}, {salario: {$lt: 20000}}]}
	]
}
)
```

![Respuesta](../img/P2%20Paso11.png)
